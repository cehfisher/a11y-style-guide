...
!function (e) {
  ...
  var e, t, n;return function e(t, n, o) {
    function i(a, c) {
      if (!n[a]) {
        if (!t[a]) {
          var l = "function" == typeof require && require;if (!c && l) return l(a, !0);if (r) return r(a, !0);var u = new Error("Cannot find module '" + a + "'");throw u.code = "MODULE_NOT_FOUND", u;
      ...
      function o(e, t, n, o, r) {
        var a = i.apply(this, arguments);return e.addEventListener(n, a, r), { destroy: function destroy() {
      ...
      function o(e, t, n) {
        ...
        return e.addEventListener(t, n), { destroy: function destroy() {
      ...
      function o() {}o.prototype = { on: function on(e, t, n) {
          ...
          var n = this.e || (this.e = {}),
              o = n[e],
              i = [];if (o && t) for (var r = 0, a = o.length; r < a; r++) {
