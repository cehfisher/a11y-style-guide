...
<p>This application is a living style guide, generated from KSS documented styles...with an accessibility twist. No matter your level of development or accessibility expertise, there are ways to <a href="https://github.com/cehfisher/a11y-style-guide" target="_blank" aria-label="Accessibility style GitHub repo">help contribute</a>.</p>
<p><div class="social-link-out"><a href="https://twitter.com/cariefisher" target="_blank" class="social-link-twitter" aria-label="Twitter account link">Follow me on Twitter</a><br><a href="https://github.com/cehfisher" target="_blank" class="social-link-github" aria-label="GitHub account link">View the project on GitHub</a></div></p></div>
